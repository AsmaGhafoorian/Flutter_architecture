...
import 'package:flutter_test_app/src/bloc/movie_detail_bloc.dart';
...
class MovieDetailState extends State<MovieDetail> {
                        ...
                        builder: (context,
                          ...
                          if (snapshot.hasData) {
                            return FutureBuilder(
                              ...
                              builder: (context,
                                  AsyncSnapshot<MovieModel> itemSnapShot) {
                                if (itemSnapShot.hasData) {
                                  if (itemSnapShot.data.items.length > 0)
  ...
  Widget noTrailer(MovieModel data) {
    return Center(
      child: Container(
